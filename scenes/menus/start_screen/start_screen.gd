...
func _on_button_button_up():
	SceneManager.load_new_scene("res://scenes/levels/test_world/LAlini/LAlini_office.tscn")
	
	#SceneManager.load_new_scene("res://scenes/levels/test_world/starting_village/start_village_h3_f0.tscn")
